...
public extension SensorType {
    init?(patchInfo: String) {
        ...
        let choices: [String: SensorType] = ["DF": .libre1, "A2": .libre1A2, "9D": .libre2, "C5": .libre2C5, "C6": .libre2Plus, "7F": .libre2PlusNew, "E5": .libreUS14day, "E6": .libreUS14dayE6, "70": .libreProH]
