...
final class APSAssembly: Assembly {
    func assemble(container: Container) {
        ...
        container.register(PluginGlucoseSource.self) { r in BasePluginGlucoseSource(resolver: r) }
        container.register(DeviceDataManager.self) { r in DeviceDataManager(resolver: r) }
