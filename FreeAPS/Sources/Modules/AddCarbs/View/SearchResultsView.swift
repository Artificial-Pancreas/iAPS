...
// MARK: - Manual Entry Nutrition Editor

private struct ManualEntryNutritionEditor: View {
    @Binding var nutritionType: ManualFoodEntrySheet.NutritionEntryType
...
// Helper view for manual entry nutrition rows
private struct ManualEntryNutritionRow: View {
    let label: String
    let portionValue: Decimal
    @Binding var baseValue: Decimal
    let unit: String

    var focusedField: FocusState<ManualEntryNutritionEditor.Field?>.Binding
    let field: ManualEntryNutritionEditor.Field
...
// Helper view for manual entry calories row (editable with auto-calculation option)
private struct ManualEntryCaloriesRow: View {
    let label: String
    let portionValue: Decimal
    @Binding var baseValue: Decimal
    let unit: String
...
// Helper view for manual entry serving size row
private struct ManualEntryServingSizeRow: View {
