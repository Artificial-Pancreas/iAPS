...
module.exports = (iaps_input) => {
    ...
    try {
        const buildMiddleware = new Function(
          `${iaps_input.middleware_fn}
           return typeof middleware === "function" ? middleware : null;`
        );
        const middleware = buildMiddleware();
        if (!middleware) {
            throw new Error("no middleware() function defined");
        }
