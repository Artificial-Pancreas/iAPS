// logging setup
if (typeof globalThis._consoleLog === 'function') {
  globalThis.console = {
    log: function (...args) {
      globalThis._consoleLog(args);
    },
    error: function (...args) {
      globalThis._consoleLog(args);
    },
  };
  globalThis.printLog = function(...args) { console.log(args); };
  globalThis.process = { stderr: { write: printLog } };
}
